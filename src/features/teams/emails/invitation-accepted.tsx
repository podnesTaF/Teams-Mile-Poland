 ...
 *
 * Carries the new roster count — a plain number, never "x of N" (ADR 0011) —
 * so the manager sees the roster grow without opening the page.
 */
...
export type TeamInvitationAcceptedCopy = {
  ...
  body: string;
  /** "The roster now has {count} runners." */
  roster: string;
  cta: string;
