import { IconTelegram, Section } from "teams-mile-warshaw";

/* IconTelegram is a bare inline SVG with no intrinsic size cap, so each cell
  ...
  return (
    <div className="flex flex-col gap-3 p-6">
      <p className="font-mono text-xs uppercase text-muted">
        Race day briefing · 22 August 2026
      </p>
      <a
        href="https://t.me/acebattlewarsaw"
        className="flex items-center gap-3 border border-line bg-bg p-4 text-ink"
      >
        <IconTelegram className="h-5 w-5" />
        <span className="font-bold">Join the Telegram channel</span>
      </a>
      <a
        href="https://t.me/acebattlerace"
